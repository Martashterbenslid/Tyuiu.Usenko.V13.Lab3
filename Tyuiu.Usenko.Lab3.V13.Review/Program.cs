...
namespace Tyuiu.Usenko.Lab3.Review.V13
{
    internal class Program
    {
        ...
        static void OptionFS()
        {
            ...
            Console.WriteLine(" Программу разработала Ющенко Валерия Евгеньевна | МКМб-22-1 | ТИУ 2024");
            Console.SetCursorPosition(0, 22);
            Console.WriteLine("------------------------------------------------------------------------------");
        ...
        static void drawMainMenu()
        {
            ...
            Console.WriteLine("║                     Выполнила Ющенко Валерия Евгеньевна                   ║");
